...
class Interface:
    ...
    def settings(self) -> None:
        ...
        settings_layout =[
            [sg.Text('Таблица со стоимостью металлов:'), sg.Text(metal_prices_table_path, size=(40,3), key='Путь к таблице металлов'), sg.FileBrowse("Выбрать другой", file_types=(("Excel files", "*.xlsx"), ("Excel files", "*.xls")), key="Таблица металлов")],
            [sg.Text('Таблица для сохранения рассчетов:'), sg.Text(accounting_table_path, size=(40,3), key='Путь к таблице с рассчетами'), sg.FileBrowse("Выбрать другой", file_types=(("Excel files", "*.xlsx"), ("Excel files", "*.xls")), key="Таблица рассчетов")],
